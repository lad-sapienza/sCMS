...
A modern static site Content Management System developed and maintained by LAD: Laboratorio di Archeologia Digitale alla Sapienza.

s:CMS is an open source, ready-to-use content management system for [generating static sites](https://www.cloudflare.com/en-gb/learning/performance/static-site-generator/) powered by [Astro](https://astro.build/). It provides data-oriented components for easily **connecting**, **displaying**, and **analyzing** research data stored in databases, flat files, or remote sources. Features include interactive maps, searchable tables, and (soon) charts.
...
Ready to get started? Read the **[Getting Started guide](/docs/guides/getting-started)**.
