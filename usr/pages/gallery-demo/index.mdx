...
export const captionsModule = Object.values(captionsData)[0];
export const captions = captionsModule?.default || captionsModule;
...
- 🔄 **Auto-loading** - Automatically discovers images in `gallery/` folders
- 📝 **Custom Captions** - Support for `captions.json` file or auto-generated from filenames
- 🎨 **Responsive Grid** - Configurable columns that adapt to screen size
- ⚡ **Optimized Images** - Astro's image optimization for fast loading
