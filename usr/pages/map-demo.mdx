...
<Example title="Example 2:Adding controls to the map">
  <Fragment slot="intro">
...
<Example title='Example 3: load geo-data from a GeoJSON file'>
  <Fragment slot="intro">
...
<Example title='Example 4: load geo-data from a CSV file with Custom Column Names and custom style'>
  <Fragment slot="intro">
...
<Example title="Example 5: Multiple Vector Layers">
  <Fragment slot="intro">
