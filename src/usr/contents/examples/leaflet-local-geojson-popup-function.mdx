...
date: "2024-10-01"
slug: "maps/examples/leaflet-local-geojson-popup-function"
...
### Leaflet: Adding a vector layer from a local GeoJSON file using a function for the popup template
