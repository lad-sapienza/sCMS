...
date: "2024-10-01"
slug: "maps/examples/maplibre-local-geojson-dropdown"
...
### MapLibre: Adding a vector layer from a local GeoJSON with advanced search implementing drop-down select
