...
import LeafletAndLocalGeoJSONCluster from "./examples/leaflet-local-geojson-cluster.mdx"
...
[Open in new page](./examples/leaflet-local-geojson-cluster)
<LeafletAndLocalGeoJSONCluster />
