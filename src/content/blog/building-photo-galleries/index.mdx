...
Need the same set of images across multiple pages, or a gallery that isn't tied to one specific article? Put it under `src/galleries/<name>/` and reference it by name from anywhere:

```
src/galleries/scavi-2024/
  photo1.jpg
  photo2.jpg
  captions.json
```
