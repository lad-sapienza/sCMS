...
import MaplibreFromJsonStyleControls from "./examples/maplibre-from-json-style-conrtrols.mdx"
...
[Open in new page](./examples/maplibre-from-json-style-controls)

<MaplibreFromJsonStyleControls />
