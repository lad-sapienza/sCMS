...
date: "2023-10-01"
slug: "modulo-mappa"
description: "An example of a map module."
menu_position: 2
---
...
import Mappa from "../modules/maps.js"

{
  <Mappa
    path2geojson="../dati/toponimi.json"
    popupTemplate={
      (feature) => { return `<p><strong>${feature.properties.nome}</strong><br />(${feature.properties.comune})`; }
    }
...
<Mappa
  ...
  popupTemplate={
    (feature) => { return `<p><strong>${feature.properties.toponimo}</strong>`; }
  }
  baseMaps={[
    {
